...
# Parámetros
# ========================================
file_in = "resultados2_tierra.txt" # Nombre del fichero de datos
file_out = "sistemasolar2_tierra" # Nombre del fichero de salida (sin extensión)
...
planet_radius = [0.2, 0.03, 0.06, 0.07, 0.05] 
#planet_radius = [0.5, 0.7, 1.1]
planet_color=["#ff7605","#5c4227","#8c4c0b","#3083ba","#991d08"]
