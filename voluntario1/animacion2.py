...
# Parámetros
# ========================================
file_in = "resultados2.txt" # Nombre del fichero de datos
file_out = "Space2" # Nombre del fichero de salida (sin extensión)
...
planet_color= ["#05f082", "#a6adaa", "#383b3a","#383b3a"] 
#planet_radius = [0.5, 0.7, 0.001, 0.001]
